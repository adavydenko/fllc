...
union _float
{
    ...
    void FromSEM(char s, char e, int m)
    {
        ...
        _value <<= 23;
        //_value |= ((m << 9) >> 9); // 9 is safed for sign (1) + exponent (8) - they should not be overriden
        _value |= (m & ((-1 << 23) ^ -1)); // 9 is safed for sign (1) + exponent (8) - they should not be overriden
    }
};
